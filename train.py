# -*- coding: utf-8 -*-
"""
Created on Wed May  2 15:00:07 2018
...
# =============================================================================
# here we build the LSTM and set some parameters
# =============================================================================
def test(model):
...
def train(EMBEDDING_DIM,HIDDEN_DIM,weight_decay,test_path,train_path,types,epochs = 30,pretrained_path=None):
    ...
    name = str(EMBEDDING_DIM)+'+'+str(HIDDEN_DIM)+'+'+str(weight_decay)+'+'+types
    model = LSTMTagger(EMBEDDING_DIM, HIDDEN_DIM, len(v.word_to_indx)+1, len(tag_to_indx),device)
    ...
    for EMBEDDING_DIM in emb_dim:
        for HIDDEN_DIM in hid_dim:
            for weight_decay in weight_decay_list:
                train(EMBEDDING_DIM,HIDDEN_DIM,weight_decay,test_path,train_path,types)
#                loadTest(EMBEDDING_DIM,HIDDEN_DIM,'./model/25+12+1e-05+TIMEX3')
